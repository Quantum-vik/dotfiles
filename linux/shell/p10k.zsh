# Generated by Powerlevel10k configuration wizard on 2026-09-13 at 00:06 IST.
...
() {
  ...
  # Left empty: the bar sits on the first line and you type after ❯ on the second, with no frame.
